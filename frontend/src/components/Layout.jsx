...
export default function Layout() {
  ...
  const subItemVisible = (s) => {
    // superAdminOnly hides links whose backend is platform infrastructure rather than tenant data,
    // so tenant roles don't hit a 403. SMS, Telegram and Instagram marketing are NO LONGER in that
    // category: V163/V164/V165 made all three per-tenant (own IG account, own bot, own campaigns),
