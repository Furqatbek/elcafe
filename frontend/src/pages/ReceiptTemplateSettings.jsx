...
const DEFAULT_TEMPLATE = {
  ...
  tagline: '',
  phone: '+998770049909',
  website: 'www.demo.restos.uz',
  footerMessage: '*** RAHMAT! ***',
  currency: 'UZS',
  showQrCode: true,
  qrUrl: 'https://demo.restos.uz/order/menu/1/TAKEAWAY',
        ...
        <div className="flex-1 space-y-6">
          ...
          <section className="bg-white rounded-lg border p-5">
            ...
            <Field label="Veb-sayt">
              <Input value={form.website} onChange={set('website')} placeholder="www.demo.restos.uz" maxLength={100} />
            </Field>
            ...
            {form.showQrCode !== false && (
              <>
                <Field label="QR URL" hint="Mijozlar skaner qilganda ochadigan havola">
                  <Input value={form.qrUrl} onChange={set('qrUrl')} placeholder="https://demo.restos.uz/menu" maxLength={500} />
                </Field>
