package uz.megahotdog.modules.settings.service;

import uz.megahotdog.modules.kitchen.entity.KitchenStation;
import uz.megahotdog.modules.kitchen.repository.KitchenStationRepository;
...
import uz.megahotdog.modules.settings.entity.PrinterSettings;
import uz.megahotdog.modules.settings.repository.PrinterSettingsRepository;
import uz.megahotdog.modules.settings.websocket.PrintAgentWebSocketHandler;
...
public class PrintService {
    ...
    private String getTableNumberFromOrder(Order order) {
        ...
        java.util.List<uz.megahotdog.modules.restaurant.entity.RestaurantTable> tables = order.getTables();
        if (tables != null && !tables.isEmpty()) {
            return tables.stream()
                    .map(uz.megahotdog.modules.restaurant.entity.RestaurantTable::getTableNumber)
