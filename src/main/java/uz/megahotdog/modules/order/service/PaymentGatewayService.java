...
import uz.megahotdog.modules.loyalty.event.LoyaltyOrderEventListener;
import uz.megahotdog.modules.order.dto.payment.PaymentIntentRequest;
import uz.megahotdog.modules.order.dto.payment.PaymentIntentResponse;
import uz.megahotdog.modules.order.dto.payment.RefundRequest;
import uz.megahotdog.modules.order.dto.payment.RefundResponse;
...
public class PaymentGatewayService {
    ...
    public RefundResponse processRefund(RefundRequest request) {
        ...
        try {
            ...
            order.setPaymentStatus(uz.megahotdog.modules.order.enums.PaymentStatus.REFUNDED);
            orderRepository.save(order);
