package uz.megahotdog.modules.order.entity;
...
public class Order {
     ...
     */
    public void addTable(uz.megahotdog.modules.restaurant.entity.RestaurantTable table, boolean isPrimary) {
        if (orderTables == null) {
     ...
     */
    public void addTable(uz.megahotdog.modules.restaurant.entity.RestaurantTable table) {
     ...
     */
    public void removeTable(uz.megahotdog.modules.restaurant.entity.RestaurantTable table) {
        if (orderTables != null) {
     ...
     */
    @JsonIgnore
    public List<uz.megahotdog.modules.restaurant.entity.RestaurantTable> getTables() {
        if (orderTables != null && !orderTables.isEmpty()) {
            return orderTables.stream()
     ...
     */
    @JsonIgnore
    public uz.megahotdog.modules.restaurant.entity.RestaurantTable getPrimaryTable() {
        if (orderTables != null && !orderTables.isEmpty()) {
            return orderTables.stream()
