package uz.megahotdog.modules.customer.controller;

import uz.megahotdog.modules.customer.dto.CustomerActivityDTO;
import uz.megahotdog.modules.customer.dto.CustomerActivityFilterDTO;
import uz.megahotdog.modules.customer.service.CustomerActivityService;
    ...
    public ResponseEntity<List<CustomerActivityDTO>> getFilteredCustomersActivity(
        ...
        CustomerActivityFilterDTO filter = CustomerActivityFilterDTO.builder()
                ...
                .registrationSource(registrationSource != null ?
                        uz.megahotdog.modules.customer.enums.RegistrationSource.valueOf(registrationSource) : null)
                .active(active)
