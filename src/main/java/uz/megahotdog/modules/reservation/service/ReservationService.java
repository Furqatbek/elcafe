package uz.megahotdog.modules.reservation.service;
...
import uz.megahotdog.modules.reservation.dto.CreateReservationRequest;
import uz.megahotdog.modules.reservation.dto.ReservationResponse;
import uz.megahotdog.modules.reservation.entity.Reservation;
import uz.megahotdog.modules.reservation.entity.ReservationSettings;
import uz.megahotdog.modules.reservation.enums.ReservationSource;
...
import uz.megahotdog.modules.reservation.repository.ReservationSettingsRepository;
    ...
    private Customer findOrCreateCustomer(Long restaurantId, CreateReservationRequest request) {
        ...
        if (request.getCustomerPhone() != null && !request.getCustomerPhone().isBlank()) {
            ...
            Customer newCustomer = Customer.builder()
                    ...
                    .registrationSource(uz.megahotdog.modules.customer.enums.RegistrationSource.RESERVATION)
                    .active(true)
                    .build();
