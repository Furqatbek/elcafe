package uz.megahotdog.bff.customer.service;

import uz.megahotdog.bff.customer.dto.CustomerMenuDTO;
...
public class CustomerMenuAssembler {
     ...
     */
    private String getFirstCouponCode(uz.megahotdog.modules.promotion.entity.Promotion promotion) {
