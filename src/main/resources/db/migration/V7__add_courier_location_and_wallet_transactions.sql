...
CREATE INDEX idx_courier_id ON courier_locations(courier_id);
CREATE INDEX idx_order_id ON courier_locations(order_id);
CREATE INDEX idx_timestamp ON courier_locations(timestamp);
...
CREATE INDEX idx_wallet_id ON courier_wallet_transactions(wallet_id);
CREATE INDEX idx_courier_id ON courier_wallet_transactions(courier_id);
CREATE INDEX idx_order_id ON courier_wallet_transactions(order_id);
CREATE INDEX idx_transaction_type ON courier_wallet_transactions(transaction_type);
CREATE INDEX idx_created_at ON courier_wallet_transactions(created_at);
