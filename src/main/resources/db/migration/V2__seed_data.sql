...
VALUES ('admin@mayamicafe.uz', '$2b$10$tk6LZVsLMogk1MKi0zAkFeYto7dM0SBmljIkA.Lc6BO8wJGLzefqG', 'Admin', 'User', 'ADMIN', TRUE, TRUE);

-- Insert default operator user (password: F8fLj8bi1yGBWqpB)
INSERT INTO users (email, password, first_name, last_name, role, active, email_verified)
VALUES ('operator@mayamicafe.uz', '$2b$10$ROuAr99Uk52NYdO5J/JyCe0C/8axTGDCvROewQgFICjVG3s8tDpLq', 'Operator', 'User', 'OPERATOR', TRUE, TRUE);
...
VALUES ('Mayami Cafe', 'Best coffee and food in town', 'Hazorasp tumani, Chitlik koprik', 'Xorazm', 'UZB', '10001', 'UZB', '+998 88 153 8888', 'info@mayamicafe.uz', TRUE, TRUE, 5.00, 30);
