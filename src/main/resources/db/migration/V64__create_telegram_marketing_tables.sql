...
('Welcome Message', '👋 Assalomu alaykum {name}!\n\nMega HotDog botiga xush kelibsiz! 🍽️\n\nBu yerda siz:\n✅ Menuni ko''rishingiz\n✅ Buyurtma berishingiz\n✅ Aksiyalar haqida bilib turishingiz mumkin', 'WELCOME', 'Sent when user starts the bot', true, '[{"text": "📋 Menuni ko''rish", "callback_data": "menu"}, {"text": "🛒 Buyurtma berish", "url": "https://demo.restos.uz/order"}]'),
('Birthday Greeting', '🎂 Tug''ilgan kuningiz bilan {name}!\n\nMega HotDog sizga 20% chegirma taqdim etadi! 🎁\n\nPromo kod: BDAY{year}\nAmal qilish muddati: bugun!', 'BIRTHDAY', 'Sent on subscriber birthday', true, '[{"text": "🛒 Buyurtma berish", "url": "https://demo.restos.uz/order"}]'),
('Inactive User', '👋 {name}, sizni sog''indik!\n\nMega HotDog''da yangi taomlar kutmoqda! 🍕🍔\n\n15% chegirma: COMEBACK15', 'REMINDER', 'Sent to inactive users', true, '[{"text": "📋 Yangi menuni ko''rish", "callback_data": "menu"}]'),
...
('Promotion', '🔥 {name}, maxsus taklif!\n\n{promo_text}\n\nPromo kod: {promo_code}\nAmal qilish: {expiry_date} gacha', 'PROMOTION', 'General promotion template', true, '[{"text": "🛒 Hoziroq buyurtma bering", "url": "https://demo.restos.uz/order"}]');
...
('/menu', 'View the menu', '📋 Bizning menuni ko''ring: https://demo.restos.uz/menu'),
('/order', 'Place an order', '🛒 Buyurtma berish: https://demo.restos.uz/order'),
('/help', 'Get help', '❓ Yordam kerakmi?\n\n📞 Telefon: +998770049909\n📍 Manzil: Hazorasp, Xorazm\n⏰ Ish vaqti: 09:00 - 23:00'),
('/promo', 'View current promotions', '🔥 Joriy aksiyalarni saytimizda ko''ring: https://demo.restos.uz/promotions');
