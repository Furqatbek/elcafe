...
('Welcome Message', 'Assalomu alaykum {name}! Mega HotDog''ga xush kelibsiz. Birinchi buyurtmangizda 10% chegirma oling. Promo kod: WELCOME10', 'WELCOME', 'Sent to new customers after registration'),
('Birthday Greeting', 'Tug''ilgan kuningiz bilan {name}! Mega HotDog sizga 20% chegirma taqdim etadi. Promo kod: BDAY{year}. Amal qilish muddati: bugun!', 'BIRTHDAY', 'Sent on customer birthday'),
('Inactive Customer', '{name}, sizni sog''indik! Mega HotDog''da yangi taomlar kutmoqda. 15% chegirma: COMEBACK15', 'REMINDER', 'Sent to customers inactive for 30+ days'),
