...
import uz.megahotdog.modules.order.enums.PaymentMethod;
...
import uz.megahotdog.modules.promotion.enums.DiscountType;
...
class POSOrderControllerTest {
    ...
    private POSOrderResponse buildResponse() {
        return POSOrderResponse.builder()
                .id(1L).orderNumber("ORD-001").status(uz.megahotdog.modules.order.enums.OrderStatus.NEW)
    ...
    void createOrder_returns201() throws Exception {
        ...
        CreatePOSOrderRequest req = CreatePOSOrderRequest.builder()
                ...
                .orderSource(uz.megahotdog.modules.order.enums.OrderSource.WALK_IN)
