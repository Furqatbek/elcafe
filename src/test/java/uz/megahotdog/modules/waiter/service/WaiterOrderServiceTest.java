...
import uz.megahotdog.modules.waiter.entity.WaiterCommission;
...
import static uz.megahotdog.modules.waiter.helper.TestDataFactory.*;
...
class WaiterOrderServiceTest {
    ...
    @Mock
    private uz.megahotdog.modules.waiter.event.OrderEventPublisher orderEventPublisher;
    ...
    class CloseOrderTests {
        ...
        private void makeOrderPaid(Order order) {
            ...
            uz.megahotdog.modules.order.entity.Payment payment = uz.megahotdog.modules.order.entity.Payment.builder()
                    .id(1L).amount(BigDecimal.valueOf(100)).tipAmount(BigDecimal.ZERO)
                    .refundedAmount(BigDecimal.ZERO).status(uz.megahotdog.modules.order.enums.PaymentStatus.COMPLETED).build();
