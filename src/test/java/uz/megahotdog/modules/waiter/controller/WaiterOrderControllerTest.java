package uz.megahotdog.modules.waiter.controller;

import uz.megahotdog.exception.GlobalExceptionHandler;
...
import uz.megahotdog.modules.waiter.helper.TestDataFactory;
import uz.megahotdog.modules.waiter.service.OrderEventService;
import uz.megahotdog.modules.waiter.service.WaiterOrderService;
...
class WaiterOrderControllerTest {
    ...
    @InjectMocks
    private WaiterOrderController waiterOrderController;

    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(waiterOrderController)
